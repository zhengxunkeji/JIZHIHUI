...
+ (void)showAlertWithTitle:(NSString *)title
    ...
    SGAlertMenu *menu = [[SGAlertMenu alloc] initWithMessage:message
...
+ (void)showSheetWithItemTitles:(NSArray *)itemTitles
             selectedIndex:(NSInteger)selectedIndex
            selectedHandle:(SGMenuActionHandler)handler{
    SGSheetMenu *menu = [[SGSheetMenu alloc] initWithItemTitles:itemTitles];
...
+ (void)showGridMenuWithItemTitles:(NSArray *)itemTitles
               ...
               selectedHandle:(SGMenuActionHandler)handler{
    SGGridMenu *menu = [[SGGridMenu alloc] initWithItemTitles:itemTitles
                                                  images:images];
    [menu triggerSelectedAction:^(NSInteger index){
        [[SGActionView sharedActionView] dismissMenu:menu Animated:YES];
        if (handler) {
