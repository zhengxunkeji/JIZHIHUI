...
//        CGContextFillPath(context);
        CGContextBeginPath(context);
        CGContextMoveToPoint(context, targetX+15, targetY+8);
        CGContextAddLineToPoint(context, targetX+25+15, targetY-25+8);
        CGContextAddLineToPoint(context, targetX+25+15, targetY+8);
